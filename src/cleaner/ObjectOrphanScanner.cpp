...
ObjectOrphanScanner::ObjectOrphanScanner(soci::connection_pool& pool, std::string storage_root)
    : pool_(pool), storage_root_(std::move(storage_root)) {
}

std::vector<std::string> ObjectOrphanScanner::find_orphaned_object_paths() {
